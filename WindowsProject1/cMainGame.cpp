...
void cMainGame::Render()
{
	...
	g_pD3DDevice->Clear(NULL, NULL, D3DCLEAR_TARGET
		| D3DCLEAR_ZBUFFER,
...
void cMainGame::Setup_Light()
{
	...
	stLight.Type = D3DLIGHT_DIRECTIONAL; // 유니티 기본 라이트
...
{
	D3DXCreateTextureFromFile(g_pD3DDevice, L"image/notice_image_05.png", &m_pTexture);
