...
void cHead::Setup()
{
	cCubeNode::Setup();
    {
        ...
        m_vecVertex[14].t.x = (float)24 / 64;   m_vecVertex[14].t.y = (float)8 / 32;    //¿ÞÂÊ¸é À­»ï°¢
                                                                     //4,5,1
