...
void cLeftArm::Setup()
{
	cCubeNode::Setup();
	{
		...
		m_vecVertex[2].t.x = (float)48 / 64; m_vecVertex[2].t.y = (float)20 / 32;  //¾Õ¸é À­»ï°¢ 
																				   //0,1,2
		...
		m_vecVertex[5].t.x = (float)48 / 64; m_vecVertex[5].t.y = (float)32 / 32;  //¾Õ¸é ¾Æ·§»ï°¢ 
																				   //0,2,3
		...
		m_vecVertex[8].t.x = (float)56 / 64; m_vecVertex[8].t.y = (float)20 / 32;  //µÞ¸é À­»ï°¢
		...
		m_vecVertex[11].t.x = (float)52 / 64; m_vecVertex[11].t.y = (float)20 / 32;  //µÞ¸é ¾Æ·§»ï°¢
		...
		m_vecVertex[14].t.x = (float)44 / 64; m_vecVertex[14].t.y = (float)20 / 32;  //¿ÞÂÊ¸é À­»ï°¢
		...
		m_vecVertex[17].t.x = (float)44 / 64; m_vecVertex[17].t.y = (float)32 / 32;  //¿ÞÂÊ¸é ¾Æ·§»ï°¢
		...
		m_vecVertex[20].t.x = (float)52 / 64; m_vecVertex[20].t.y = (float)20 / 32;  //¿À¸¥¸é À­»ï°¢
		...
		m_vecVertex[23].t.x = (float)52 / 64; m_vecVertex[23].t.y = (float)32 / 32;  //¿À¸¥¸é ¾Æ·§»ï°¢
		...
		m_vecVertex[26].t.x = (float)48 / 64; m_vecVertex[26].t.y = (float)16 / 32;  //À­¸é À­»ï°¢
		...
		m_vecVertex[29].t.x = (float)48 / 64; m_vecVertex[29].t.y = (float)20 / 32;  //À­¸é ¾Æ·§»ï°¢
		...
		m_vecVertex[32].t.x = (float)52 / 64; m_vecVertex[32].t.y = (float)20 / 32;  //¾Æ·§¸é À­»ï°¢
		...
		m_vecVertex[35].t.x = (float)52 / 64; m_vecVertex[35].t.y = (float)16 / 32;  //¾Æ·§¸é ¾Æ·§»ï°¢
	}
